...
class BIP66Test(MorriganTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # morrigand is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and morrigand produces more specific reject
            # reasons.
