...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MorriganTestFramework
    pass

class ExampleTest(MorriganTestFramework):
    # Each functional test is a subclass of the MorriganTestFramework class.
    ...
    def custom_method(self):
        ...
        MorriganTestFramework class so other tests can use it."""
