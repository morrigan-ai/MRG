...
class AssetTest(MorriganTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("MORRIGAN1", 1000)
        n0.issue("MORRIGAN2", 1000)
        n0.issue("MORRIGAN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="MORRIGAN*", verbose=False, count=2, start=-2)
        ...
        morrigan_assets = n0.listassets(asset="MORRIGAN*", verbose=False, count=2, start=-2)
        assert_equal(len(morrigan_assets), 2)
        assert_equal(morrigan_assets[0], "MORRIGAN2")
        assert_equal(morrigan_assets[1], "MORRIGAN3")
        self.sync_all()
