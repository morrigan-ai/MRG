...
class WalletTest(MorriganTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 MRG from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 MRG with subtract fee from amount
        ...
        # Sendmany 10 MRG with subtract fee from amount
