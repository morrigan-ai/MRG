...
class TestMorriganCli(MorriganTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `morrigan-cli getinfo`")
        ...
        self.log.info("Compare responses from `morrigan-cli -getinfo` and the RPCs data is retrieved from.")
