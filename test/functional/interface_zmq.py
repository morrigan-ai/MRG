...
import os
import struct
from test_framework.test_framework import MorriganTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(MorriganTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that morrigan has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("morrigand has not been built with zmq enabled.")
