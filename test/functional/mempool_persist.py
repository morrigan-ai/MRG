...
By default, morrigand will dump mempool on shutdown and
...
class MempoolPersistTest(MorriganTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give morrigand a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent morrigand from writing mempool.dat to disk. Verify that `savemempool` fails")
