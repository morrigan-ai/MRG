...
class TxnMallTest(MorriganTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 MRG:
        ...
        # First: use raw transaction API to send 1240 MRG to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MRG coin each
        ...
        # Node0's balance should be starting balance, plus 50MRG for another
        ...
        # Node0's total balance should be starting balance, plus 100MRG for 
