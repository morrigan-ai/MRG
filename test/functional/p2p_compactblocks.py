...
# TestNode: A peer we use to send messages to morrigand, and store responses.
...
class CompactBlocksTest(MorriganTestFramework):
    ...
    # This test actually causes morrigand to (reasonably!) disconnect us, so do this last.
    ...
    # Test that morrigand requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for morrigand to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # morrigand will not send blocktxn responses for blocks whose height is
