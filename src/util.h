 ...
 */
#ifndef MORRIGAN_UTIL_H
#define MORRIGAN_UTIL_H
...
extern const char *const MORRIGAN_CONF_FILENAME;
extern const char *const MORRIGAN_PID_FILENAME;
...
{
    std::string s = strprintf("morrigan-%s", name);
