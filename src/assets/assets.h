...
#ifndef Morrigancoin_ASSET_PROTOCOL_H
#define Morrigancoin_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_MORRIGAN_ASSET MRGQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_MORRIGAN_ASSET MRGO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_MORRIGAN_ASSET MRGR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_MORRIGAN_ASSET MRGT
...
#endif //Morrigancoin_ASSET_PROTOCOL_H
