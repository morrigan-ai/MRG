...
CAmount AmountFromValue(const UniValue& value, bool p_isMRG)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Morrigan server stopping";
}
...
{
    return "> morrigan-cli " + methodname + " " + args + "\n";
}
