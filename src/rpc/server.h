...
#ifndef MORRIGAN_RPCSERVER_H
#define MORRIGAN_RPCSERVER_H
...
/**
 * Morrigan RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isMRG = true);
