...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler MRG tx
        CScript MRGTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut MRGOut(1*COIN, MRGTransfer);
        ...
        mutTxTest1.vout.emplace_back(MRGOut);
        ...
        mutTxTest2.vout.emplace_back(MRGOut);
        ...
        mutTxTest3.vout.emplace_back(MRGOut);
        ...
        mutTxTest4.vout.emplace_back(MRGOut);
        ...
        mutTxTest5.vout.emplace_back(MRGOut);
        ...
        mutTxTest6.vout.emplace_back(MRGOut);
        ...
        mutTxTest7.vout.emplace_back(MRGOut);
        ...
        mutTxTest8.vout.emplace_back(MRGOut);
