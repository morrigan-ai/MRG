...
#ifndef MORRIGAN_TEST_SCRIPTNUM10_H
#define MORRIGAN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Morrigan Core 0.10.0, for cross-comparison.
 */
public:
