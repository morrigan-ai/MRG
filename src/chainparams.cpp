...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-morrigan.bitactivate.com", false);
        vSeeds.emplace_back("seed-morrigan.Morrigancoin.com", false);
        vSeeds.emplace_back("seed-morrigan.Morrigancoin.org", false);
        ...
        // Morrigan BIP44 cointype in mainnet is '175'
        nExtCoinType = 175;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Morrigan chain
...
public:
    CTestNetParams() {
        ...
        consensus.nMaxMoneyOut = 42000000000 * COIN; // 42B
...
//            genesis = CreateGenesisBlock(nGenesisTime, i, 0x1e00ffff, 2, 10000 * COIN);
...
//        /////////////////////////////////////////////////////////////////
        ...
        genesis = CreateGenesisBlock(nGenesisTime, 15615880, 0x1e00ffff, 2, 10000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();
        ...
        vSeeds.emplace_back("seed-testnet-morrigan.bitactivate.com", false);
        vSeeds.emplace_back("seed-testnet-morrigan.Morrigancoin.com", false);
        vSeeds.emplace_back("seed-testnet-morrigan.Morrigancoin.org", false);
        ...
        // Morrigan BIP44 cointype in testnet
        nExtCoinType = 1;
...
//        uint256 BestBlockHash = uint256S("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
//        for (int i=0;i<40000000;i++) {
//            genesis = CreateGenesisBlock(1533751200, i, 0x207fffff, 2, 10000 * COIN);
//            //genesis.hashPrevBlock = TempHashHolding;
//            consensus.hashGenesisBlock = genesis.GetHash();
//
//            arith_uint256 BestBlockHashArith = UintToArith256(BestBlockHash);
...
//        /////////////////////////////////////////////////////////////////
        ...
        // Morrigan BIP44 cointype in regtest
        nExtCoinType = 1;
