...
#ifndef MORRIGAN_QT_OPTIONSMODEL_H
#define MORRIGAN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Morrigan client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // MorriganUnits::Unit
...
#endif // MORRIGAN_QT_OPTIONSMODEL_H
