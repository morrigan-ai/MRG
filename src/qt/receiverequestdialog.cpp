...
#include "config/morrigan-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMorriganURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MorriganUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMorriganURI(info));
}
