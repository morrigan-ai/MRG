    ...
    mapper(0)
{
    ...
    ui->morriganAtStartup->setToolTip(ui->morriganAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->morriganAtStartup->setText(ui->morriganAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openMorriganConfButton->setToolTip(ui->openMorriganConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new MorriganUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->morriganAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMorriganConfButton_clicked()
{
