...
#include "qt/morriganamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MorriganAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_morrigan-qt -platform xcb      # Linux
//     src/qt/test/test_morrigan-qt -platform windows  # Windows
//     src/qt/test/test_morrigan-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = MorriganUnits::formatWithUnit(unit, balance, false, MorriganUnits::separatorAlways);
    ...
    // Amount input
    MorriganAmountField* amountInput = receiveCoinsDialog.findChild<MorriganAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: morrigan:")) != -1);
