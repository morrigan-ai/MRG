...
#ifndef MORRIGAN_QT_GUIUTIL_H
#define MORRIGAN_QT_GUIUTIL_H
...
/** Utility functions used by the Morrigan Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "morrigan:" URI into recipient object, return true on successful parsing
