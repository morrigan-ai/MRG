...
#ifndef MORRIGAN_QT_RECEIVECOINSDIALOG_H
#define MORRIGAN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of morrigans */
...
#endif // MORRIGAN_QT_RECEIVECOINSDIALOG_H
