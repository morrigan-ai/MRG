...
#ifndef MORRIGAN_QT_MORRIGANGUI_H
#define MORRIGAN_QT_MORRIGANGUI_H
...
/**
  Morrigan GUI main class. This class represents the main window of the Morrigan UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MorriganGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MorriganGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MorriganGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a morrigan wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QComboBox *comboMRGUnit = nullptr;
...
#endif // MORRIGAN_QT_MORRIGANGUI_H
