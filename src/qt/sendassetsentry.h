...
#ifndef MORRIGAN_QT_SENDASSETSENTRY_H
#define MORRIGAN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending morrigans.
...
#endif // MORRIGAN_QT_SENDASSETSENTRY_H
