...
void WalletView::setMorriganGUI(MorriganGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? MorriganGUI::HD44_ENABLED : _walletModel->hdEnabled() ? MorriganGUI::HD_ENABLED : MorriganGUI::HD_DISABLED);
