...
#ifndef MORRIGAN_SCRIPT_SCRIPT_H
#define MORRIGAN_SCRIPT_SCRIPT_H
...
public:
    ...
    bool GetOp2(const_iterator& pc, opcodetype& opcodeRet, std::vector<unsigned char>* pvchRet) const
    {
        ...
        // If we see an op MRG asset, we consider all data after it has data, and not op codes
        // Move the pc to the end of the script
        if (opcode == OP_MRG_ASSET) {
    ...
    /**
     * Pre-version-0.6, Morrigan always counted CHECKMULTISIGs
...
#endif // MORRIGAN_SCRIPT_SCRIPT_H
