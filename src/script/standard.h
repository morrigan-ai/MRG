...
#ifndef MORRIGAN_SCRIPT_STANDARD_H
#define MORRIGAN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_MORRIGAN_ASSET script that carries data
    /** MRG END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a Morrigancoin address
 */
...
/**
 * Generate a Morrigan scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MORRIGAN_SCRIPT_STANDARD_H
