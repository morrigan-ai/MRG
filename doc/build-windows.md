...
Below are some notes on how to build Morrigan Core for Windows.
...
way. This will install to `c:\workspace\morrigan`, for example:

    make install DESTDIR=/mnt/c/workspace/morrigan
