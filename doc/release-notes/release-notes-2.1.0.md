Morrigan Core version *2.1.0* is now available!!
==============

  <https://github.com/morrigan-ai/MRG/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/morrigan-ai/MRG/commits/release_2.1.0>
