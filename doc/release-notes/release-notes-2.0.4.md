Morrigan Core version *2.0.4.0* is now available!!
==============

  <https://github.com/morrigan-ai/MRG/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/morrigan-ai/MRG/commits/release_2.0.4>
