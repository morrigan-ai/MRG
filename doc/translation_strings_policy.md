...
This document provides guidelines for internationalization of the Morrigan Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `morrigan_en.ts` remains unchanged.
