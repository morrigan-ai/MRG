...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of Morrigancoin that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like morrigand does for MRG)
...
* Run a contest: MRG prize for best idea for new Morrigancoin based Business
...
* Back-end API platform for Morrigancoin
    * Other people to hit high-availablity API
* Fee system to pay MRG fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of MRG for fees.
...
* #KYC tagger - store info and tag Morrigancoin addresses
* #ACCREDITED - verify accredited status and tag Morrigancoin addresses
 
### Technical Consultant
* Help companies apply Morrigancoin capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional MRG and asset support


### Areas for Morrigancoin Innovation
* Financial
