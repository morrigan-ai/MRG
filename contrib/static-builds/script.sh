...
rm -rf ~/Morrigancoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../Morrigancoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../Morrigancoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/Morrigancoin/temp
cd ~/Morrigancoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/Morrigancoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/Morrigancoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
